...
J. Neurophysiol. 93, 2194-2232, 2005
        ...
        */
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // Found a generic form of rate equation for tau, using expression: 0.204 + 0.333 / ( (exp ((15.8 + v) / 18.2 )) + (exp ((- v - 131) / 16.7)) )
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // Found a generic form of rate equation for tau, using expression: v < -81.0 ? 0.333 * (exp (( v + 466 ) / 66.6)) : 9.32 + 0.333 * (exp (( - v - 21 ) / 10.5))
            // Will translate this for GENESIS compatibility...
