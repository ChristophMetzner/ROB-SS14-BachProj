...
J. Neurophysiol. 93, 2194-2232, 2005
        ...
        */
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // Found a generic form of rate equation for tau, using expression: 0.185 + 0.5 / ((exp (( v + 35.8 )/19.7)) + (exp ((-v - 79.7)/12.7)))
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // Found a generic form of rate equation for tau, using expression: v < -63.0 ? 0.5 / ((exp (( v + 46 )/5)) + (exp (( -v - 238 )/37.5))) : 9.5
            // Will translate this for GENESIS compatibility...
