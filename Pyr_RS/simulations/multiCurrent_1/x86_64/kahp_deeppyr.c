...
extern int nrn_get_mechtype();
 ...
 "settables_kahp_deeppyr", _hoc_settables,
 0, 0
};
 ...
 "gmax_kahp_deeppyr", "S/cm2",
 "gion_kahp_deeppyr", "S/cm2",
 "mtau_kahp_deeppyr", "ms",
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 kahp_deeppyr /home/kloskowski/Desktop/GenAlg-Kloskowski/Pyr_RS/generatedNEURON/x86_64/kahp_deeppyr.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: kahp_deeppyr";
...
static int  settables ( _p, _ppvar, _thread, _nt, _lv , _lcai ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _lcai ;
 {
  ...
  _ltemp_adj_m = 1.0 ;
   _lca_conc = _lcai ;
   _lca_conc = _lca_conc / 1000000.0 ;
   if ( _lca_conc < 0.0001 ) {
     _lalpha = _lca_conc / 0.01 ;
     }
   else {
     _lalpha = 0.01 ;
     }
