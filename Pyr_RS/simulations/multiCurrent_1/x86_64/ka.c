	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ka /home/kloskowski/Desktop/GenAlg-Kloskowski/Pyr_RS/generatedNEURON/x86_64/ka.mod\n");
...
static int _reset;
static char *modelname = "Channel: ka";
...
static int  _f_rates ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
  ...
  _ltemp_adj_m = 1.0 ;
   ...
   minf = _linf ;
   if ( _lv < - 63.0 ) {
     _ltau = 0.5 / ( ( exp ( ( _lv + 46.0 ) / 5.0 ) ) + ( exp ( ( - _lv - 238.0 ) / 37.5 ) ) ) ;
     }
   else {
     _ltau = 9.5 ;
     }
