...
extern int nrn_get_mechtype();
 ...
 "vtrap_cal", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_cal
 extern double vtrap();
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 cal /home/kloskowski/Desktop/GenAlg-Kloskowski/Pyr_RS/generatedNEURON/x86_64/cal.mod\n");
